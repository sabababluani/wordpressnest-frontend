...
const Notifications = (): JSX.Element => {
  const [_, setIsEnabledHostingMessages] = useState<boolean>(false);
  const [__, setIsEnabledEmailNotifications] = useState<boolean>(false);
  const [___, setIsEnabledSiteMonitoring] = useState<boolean>(false);
