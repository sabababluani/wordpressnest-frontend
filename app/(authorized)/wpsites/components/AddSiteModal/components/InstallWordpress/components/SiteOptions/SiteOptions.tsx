        ...
        <div className={styles.infoWrapper}>
          <div className={styles.info}>
            ...
            <span className={styles.text}>
              ...
              geographical location closest to your visitors. Boosted regions
              are data center locations where we have made considerably faster
            ...
            <div className={styles.checkboxWrapper}>
              <div className={styles.checkbox}>
                <Checkbox
                  ...
                  onChange={(e) =>
                    handleCheckboxChange('cdn', e.target.checked)
                  }
                />
              </div>
