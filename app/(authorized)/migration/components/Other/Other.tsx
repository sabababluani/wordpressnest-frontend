...
const Other = () => {
    return (
        <div className={styles.mainWrapper} >
            <span className={styles.mainCaptionStyle} >Enter the URL and access details to your hosting panel below. Your hosting panel is where you currently log in to manage your domains and other hosting details. Depending on your host they may call the hosting panel <span className={styles.boldContent} >cPanel, WHM, Plesk</span> or other names.</span>
