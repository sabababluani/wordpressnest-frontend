...
const DigitalOcean = () => {
    return (
        <div className={styles.mainContainer} >
            <span className={styles.mainCaptionStyle} >You will need to provide your SSH credentials to export your site data for moving it over to your Kinsta account.</span>
            <TabsAnt
                withoutPadding
