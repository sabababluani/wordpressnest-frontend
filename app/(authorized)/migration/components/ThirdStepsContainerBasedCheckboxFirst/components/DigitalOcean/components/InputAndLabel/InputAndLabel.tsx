...
const InputAndLabel = (props: InputLabelPropsInterface) => {
  ...
  const handleFirstInputChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
    setFirstInputValue(e.target.value);
  };

  const handleSecondInputChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
    setSecondInputValue(e.target.value);
  };

  return (
    <div className={styles.mainContainer}>
      <div className={props.strechedInput ? styles.strechedWrapper : styles.wrapper}>
      ...
      </div>
      {
        ...
        <>
          <div className={styles.wrapper}>
            <span className={styles.inputLabelStyle}>{props.secondColumnLabel}</span>
            <input
