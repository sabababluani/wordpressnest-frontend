...
const Ionos = () => {
    return (
        <div className={styles.mainContainer} >
            <span className={styles.mainCaptionStyle} >We will need to access your <u>Ionos account</u> to export your site data for moving it over to your Kinsta account. If you have 2-factor authentication enabled, please disable it now for the time of the migration.</span>
