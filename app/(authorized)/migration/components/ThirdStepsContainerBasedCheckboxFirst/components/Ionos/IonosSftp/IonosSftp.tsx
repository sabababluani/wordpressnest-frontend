...
import styles from "./IonosSftp.module.scss";
...
const SFTP = () => {
    ...
    return (
        <div className={styles.mainWrapper}>
            ...
            <div className={styles.wrapperContainer}>
                <div className={styles.wrapper}>
                    <span className={styles.inputsLabelStyle}>SFTP username</span>
                    <input
                        type="text"
                        className={styles.inputContainer}
                        value={username}
                ...
                <div className={styles.wrapper}>
                    <span className={styles.inputsLabelStyle}>SFTP password</span>
                    <input
                        type="text"
                        className={styles.inputContainer}
                        value={password}
