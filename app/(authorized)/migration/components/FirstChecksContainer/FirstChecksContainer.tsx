            ...
            <div className={styles.firstChecksFirstContairsWrapper}>
              ...
              <div className={styles.firstChecksSmallWrapper}>
                ...
                <span className={styles.firstChecksDescriptionStyle}>
                  To perform the transfer we ask for a number of passwords. We
                  value and guard your privacy. This form is highly secured over
                  SSL.
                </span>
              </div>
              <div className={styles.firstChecksSmallWrapper}>
              ...
              <div className={styles.firstChecksSmallWrapper}>
                ...
                />
                <span className={styles.firstChecksDescriptionStyle}>
                  We will scan and remediate Malware on any sites transferred to
                  us for free as part of our Security Guarantee.
                </span>
              </div>
            </div>
            ...
            <div className={styles.firstChecksFirstContairsWrapper}>
              ...
              <div className={styles.firstChecksSmallWrapper}>
                <span className={styles.descriptionsWithoutIcons}>
                  ...
                  we&apos;ll send you an update when the migration starts. We
                  will then keep you informed about its progress.
                </span>
              </div>
              <div className={styles.firstChecksSmallWrapper}>
                <span className={styles.descriptionsWithoutIcons}>
                  Once the migration is complete we&apos;ll send you details for
                  testing the site, and instructions on how you&apos;ll be able
                  to point your website to Kinsta if everything looks good.
                </span>
              </div>
            </div>
          </div>
