...
const SelectionsWrapper = (props: SelectionsWrapperProps): JSX.Element => {
  ...
  const [activeCheckbox, setActiveCheckbox] = useState<number | null>(props.initialActiveCheckbox || null);
    ...
    <div className={styles.mainContainer}>
      ...
      >
        ...
        <div className={styles.belowInnerContentsWrapper}>
          <Image width={64} height={64} src="/icons/clock.svg" alt="clock icon" />
          <div className={styles.captionsWrapper}>
            <span className={styles.checkboxMainCaption}>As soon as possible</span>
            <span className={styles.checkboxDescription}>
              We will give a heads up before we start but will not wait for a specific approval.
            </span>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className={styles.belowInnerContentsWrapper}>
          <Image width={64} height={64} src="/icons/calendarSecond.svg" alt="calendar icon" />
          <div className={styles.captionsWrapper}>
            <span className={styles.checkboxMainCaption}>On a specific date</span>
            <span className={styles.checkboxDescription}>
      ...
      >
        ...
        <div className={styles.belowInnerContentsLastWrapper}>
          <Image width={64} height={64} src="/icons/lighting.svg" alt="lighting icon" />
          ...
          <div className={styles.captionsWrapper}>
            ...
            <span className={styles.checkboxDescription}>
              If we don&apos;t deliver within this time frame, we&apos;ll refund your payment.
            </span>
          </div>
        </div>
      </div>
