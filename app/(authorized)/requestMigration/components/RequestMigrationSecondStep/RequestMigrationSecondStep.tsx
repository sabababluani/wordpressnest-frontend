...
const RequestMigrationSecondStep = (): JSX.Element => {
    ...
    return (
        <div className={styles.mainContainer} >
            <div className={`${styles.containerWrapper} ${activeCheckboxIndex == 1 ? styles.containerWrapperActive : styles.containerWrapperInActive}`} onClick={() => checkboxDetector(1)} >
            ...
            <div className={`${styles.containerWrapper} ${activeCheckboxIndex == 2 ? styles.containerWrapperActive : styles.containerWrapperInActive}`} onClick={() => checkboxDetector(2)} >
                <div className={styles.checkboxWrapper}>
