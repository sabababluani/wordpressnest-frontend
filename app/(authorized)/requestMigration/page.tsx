...
import SecondChecksContainer from "./components/SecondCheksContainer/SecondChecksContainer";
    ...
    return (
        <div className={styles.mainWrapper}>
            <div className={styles.unChangableWrapper}>
                ...
                <SelectionsWrapper
                    onCheckboxChange={(activeIndex: number | null) => setActiveCheckbox(activeIndex)}
                ...
                {activeCheckbox === 3 && (
                    <>
                        <div className={styles.thirdCheckboxBottomContainer}>
                            <span className={styles.thirdChecksMainCaptionStyle} >We offer unlimited free migrations from all hosting providers including: A2 Hosting, Bluehost, Cloudways, DreamHost, Flywheel, GoDaddy, HostGator, Pagely, Pantheon, SiteGround, tsoHost, WP Engine, or WPX Hosting.</span>
                        </div>
                    </>
                )}
            </div>
                        ...
                        stepFlow == 1 ?
                            ...
                            <>
                                <button
                                    ...
                                    onClick={() => setStepFlow((prev: number) => prev == 1 ? prev : prev - 1)}
                                >
                                    Back
                                </button>
                            </>
                    }
                    <button className={styles.NextButtonStyle} onClick={() => {
